...
With relation to systems, didactic literature recommends examining multiple layers of a system, for students to better understand the material. This concept (later called \emph{Sichtenwechsel} for lack of a better fitting English term) is introduced in \ref{ssc_sichtenwechsel} and is considered a foundational idea that should be exploited in teaching as well as also taught explicitly (elaborated in \ref{ssc_fundamentale_ideen}).
