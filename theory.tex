...
\item Difference to bottom-up development: small building blocks, build abstractions out of them
\item Bottom up development is how students approach programming (\cite{Mod16})
\end{todo}
...
\item Difference to top-down development: start at abstraction, simplify/modularize it for implementation
\end{todo}
