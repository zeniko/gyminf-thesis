...
This thesis presents an environment for teaching programming classes and computer architecture at high school level that allows students to experience and explore interactively various abstraction layers involved in running a program.
