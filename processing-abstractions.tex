...
\begin{figure} \label{fig_views_parser}
\centering
\includegraphics{images/screenshot_parser}
\lessSpace
\caption{Screenshot of a page of student content showing modifyable Processing source with live views for tokenization (left) and abstract syntax tree (right).}
\end{figure}
