...
\begin{class}[text width=6.6cm]{GtProcessingCoderModel}{8, 2.1}
\operation{doIt:}
\operation{doItAndGo:}
...
\draw[umlcd style dashed line, ->] (LeProcessingSnippet.east) -- node[black, rotate=90]{newCoder} (GtProcessingCoderModel);
