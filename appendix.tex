...
Before running it, create a new text file called \ct{startup.st} in GT's top-level folder besides \ct{GlamorousToolkit.image} with the following content (access it through figure \ref{fig_startup_st_qr}):
