...
\lstset{
	...
	basicstyle=\footnotesize\ttfamily\fontencoding{T1}\selectfont,
	% background
	frame=single,
    framerule=0pt,
...
\newcommand{\archivedurl}[1]{\href{https://web.archive.org/web/*/#1}{\nolinkurl{#1}}}
...
% Questionnaire based on https://github.com/annerosenisser/latex-surveys
...
\newcounter{qr}
\newcommand{\Qrating}[1]{$\Box$\forloop{qr}{1}{\value{qr}<#1}{---$\Box$}}
\newcounter{ql}
\newcommand{\Qlines}[1]{\forloop{ql}{0}{\value{ql}<#1}{\vskip0em\noindent\rule{\linewidth}{0.5pt}}}
\newenvironment{Qlist}[1][$\Box$]{
	\begin{list}{#1}{}
}{
	\end{list}
}
...
\newcommand{\thesisauthor}{Simon Bünzli Straub}
\newcommand{\thesisauthorOrigin}{Bern, Switzerland}
\newcommand{\thesisleiter}{Prof.\ Dr.\ Timo Kehrer, Prof.\ Dr.\ em.\ Oscar Nierstrasz}
\newcommand{\thesisasst}{}
\newcommand{\thesisurl}{http://seg.inf.unibe.ch/}
\newcommand{\thesissubtitle}{Introducing a Learning Environment to Examine Programs \\ from Source Code to Bytecode}
\newcommand{\thesisdate}{21. August 2025}
...
\begin{titlepage}  
  ...
  \center{\includegraphics[scale=0.2]{logos/gyminf_logo.png}}
  \vspace{0.4in}     
  \end{figure}
