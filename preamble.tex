...
\newcommand{\xxx}[1]{\textbf{!` \faTasks {#1}!}\PackageWarning{ToDo}{!!! #1 !!!}}
...
\newcommand{\thesisauthor}{Simon Bünzli}
...
\newcommand{\thesisdate}{01. August 2025}
...
\begin{titlepage}  
  ...
  \end{figure}
   ...
   {\Large \thesisleiter} \par
      {\Large \thesisasst} \par
   \vspace{0.1in}
    {\Large Software Engineering Group \par Institut f\"{u}r Informatik und angewandte Mathematik \par University of Bern, Switzerland \par}
